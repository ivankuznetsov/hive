...
provenance, loads every bounded cited source line from that commit, and checks
it in a checkout of the fresh default. Evidence continues when the full line
is unchanged or moved byte-for-byte to one unique location.
