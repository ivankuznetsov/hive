...
- The web dashboard reads `hive daemon status --json` for daemon health and
  ...
  the daemon dispatch queue rather than executing from the Rails process.
