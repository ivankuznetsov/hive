...
fail the expected-source check.
...
- `test/integration/doctor_config_validation_test.rb` covers shared root-key failures, exit 78, reviewer migration guidance, and the fail-before-probes boundary.
