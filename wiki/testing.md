...
| `workflows/bench_test.rb` (judge adapter) | Pins stderr quota classification, Claude CLI's exact standalone stdout reset banner, and rejection of model-authored quota prose. |
