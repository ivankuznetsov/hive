...
- `test/unit/babysitter/passthrough_policy_test.rb` directly exercises both pure classifiers and the shared runner's skip, validation, preparation, handoff, and error-mapping contract.
