...
curl -fsSL https://raw.githubusercontent.com/ivankuznetsov/hive/v0.5.1/install.sh -o "$tmpdir/hive-install.sh"
...
```bash
packaging/verify-release.sh --version=v0.5.1
packaging/verify-release.sh --version=v0.5.1 --report=json | jq .ok
```
