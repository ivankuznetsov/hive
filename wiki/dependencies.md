...
| `git` | 2.40+ generally; babysitter dry-run reads require the 2.45+ `--no-lazy-fetch` capability | `Hive::GitOps`, `Hive::Worktree`, `Init`/`New` commands, `Hive::Babysitter::DryRunEnv` |
