...
class ExitCodesTest < Minitest::Test
  ...
  def test_error_subclasses_map_to_their_contract_code
    ...
    assert_equal Hive::ExitCodes::WRONG_STAGE,         Hive::FinalStageReached.new("x", stage: "9-done").exit_code
  ...
  def test_task_action_kind_closed_enum_membership
    expected = %w[
      ready_to_brainstorm ready_to_plan ready_to_develop outcome_evidence_rework ready_to_open_pr ready_for_review
