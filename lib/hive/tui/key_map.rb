...
module Hive
  module Tui
    ...
    module KeyMap
      ...
      # is routed by `error_message` to the recovery coordinator.
      # `recover_execute` is also intentionally
      ...
      # Enter on every `error` row submits the observed marker to the
      # shared recovery coordinator. Marker comparison and durable
      # deduplication happen below the TUI adapter.
