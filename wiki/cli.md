...
Thor usage errors that happen after wrapper normalization but before command
objects are constructed are routed through schema-specific JSON envelopes for
