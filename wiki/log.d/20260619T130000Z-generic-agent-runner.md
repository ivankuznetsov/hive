...
`templates/agent_prompt.md.erb`. The runner resolves the current stage from the
workflow registry, reads prior markdown artifacts with a per-spawn nonce wrapper,
