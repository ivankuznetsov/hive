...
class SchemaFilesTest < Minitest::Test
  ...
  def test_status_schemas_accept_parked_review_diagnostics_and_recovery_routes
    ...
    route = {
      ...
      "identity_contract_recovery" => true, "identity_contract_version" => 2,
      "planner_identity_contract_recovery" => true,
      "planner_identity_contract_version" => 1,
      ...
      "planner_revision_contract_version" => 2,
      "contract_upgrade_recovery" => true,
      "transient_series_recovery" => true, "transient_series" => 2,
  ...
  def test_hive_daemon_status_required_keys_match_producer_emission
    ...
    producer_required = %w[
      ...
      runtime_installation lifecycle quiescence_capability current_version update_nudge
    ].sort
    assert_equal producer_required, schema_required,
