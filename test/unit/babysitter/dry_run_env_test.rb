...
class BabysitterDryRunEnvTest < Minitest::Test
  ...
  def test_stubs_skip_unknown_and_mutating_commands_but_allow_read_only_commands
    with_tmp_dir do |dir|
      ...
      assert_stubbed env, "git", "-c", "diff.external=sh -c echo-pwn", "diff"
      assert_stubbed env, "git", "-c", "core.fsmonitor=sh -c echo-pwn", "status"
      assert_stubbed env, "git", "-c", "core.pager=sh -c echo-pwn", "log"
      assert_stubbed env, "git", "-c", "pager.log=sh -c echo-pwn", "log"
      assert_stubbed env, "git", "-c", "alias.status=!sh -c echo-pwn", "status"
      assert_stubbed env, "git", "-c", "protocol.ext.allow=always", "status"
      assert_stubbed env, "git", "-c", "core.hooksPath=.git/hooks", "status"
      assert_stubbed env, "git", "-c", "include.path=/tmp/evil", "diff"
      assert_stubbed env, "git", "-c", "includeIf.gitdir:/tmp/.path=/tmp/evil", "diff"
      assert_stubbed env, "git", "--config-env=diff.external=HIVE_DIFF_EXTERNAL", "diff"
      ...
      assert_includes skipped, "git -c diff.external=sh -c echo-pwn diff skipped"
      assert_includes skipped, "git -c core.fsmonitor=sh -c echo-pwn status skipped"
      assert_includes skipped, "git -c core.pager=sh -c echo-pwn log skipped"
      assert_includes skipped, "git -c pager.log=sh -c echo-pwn log skipped"
      assert_includes skipped, "git -c alias.status=!sh -c echo-pwn status skipped"
      assert_includes skipped, "git -c protocol.ext.allow=always status skipped"
      assert_includes skipped, "git -c core.hooksPath=.git/hooks status skipped"
      assert_includes skipped, "git -c include.path=/tmp/evil diff skipped"
      assert_includes skipped, "git -c includeIf.gitdir:/tmp/.path=/tmp/evil diff skipped"
      assert_includes skipped, "git --config-env=diff.external=HIVE_DIFF_EXTERNAL diff skipped"
