...
The babysitter dry-run suite also pre-creates mode-`0644` skip logs and verifies that both executable stubs tighten them to `0600` before appending skipped argv.
