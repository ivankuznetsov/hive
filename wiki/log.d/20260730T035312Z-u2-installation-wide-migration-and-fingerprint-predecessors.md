...
- Added one root-owned, locked, bounded, round-robin machine checkpoint so an
  hourly retry resumes later profiles without rewriting terminal progress.
  Checkpoint rows revalidate their profile digest and complete nested project
  schema before they can suppress another attempt.
