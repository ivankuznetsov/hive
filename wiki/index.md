...
component-to-component edge; Patrol Effect Evidence retains the one bounded
U3 qualification exception. Attempts, Patrol Effect Evidence, and the Workflow Creator Proof Contract are the three
guarded `candidate` boundaries. Hive is the first and primary consumer, and internal readiness does not imply a gem,
