...
created: 2026-06-04
updated: 2026-09-11
tags: [command, web, rails, turbo, hivebox-container, plan-review, archive, retention, dogfood, daily-digest, brainstorm, suggestions]
---
...
- **Agents** — PTY login relay (ADR-035) with a polled turbo-frame instead of
  ...
  paste-back `claude setup-token` flow. Grok status recognizes
  `GROK_AUTH_PATH` and credentials under `GROK_HOME`; API keys are not Hive
  login state. Raw PTY bytes are scrubbed to
