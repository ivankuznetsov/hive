...
1. Reconcile every durable finding with merged/open fingerprint state and closed-unmerged dismissals. Legacy records load as active. Resolved and rejected roots remain terminal for the SHA where they were dispositioned, while matching evidence on a newer target may start a new active recurrence lineage.
