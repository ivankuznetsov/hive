...
Queued commit `d28377b2` changes the final browser wait to target that durable
PR-gate result rather than the transient `execute` badge: a fast daemon may
