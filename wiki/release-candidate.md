...
baseline catalog. Its `latest-stable` alias is pinned to v0.7.2; historical
...
The checked-in source metadata is prepared as 0.7.3 while the reviewed
latest-stable alias remains v0.7.2, clearing only the candidate-version
