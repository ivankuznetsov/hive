...
oversized, scan-truncated, daemon-stopped, row/string, schema, and 64 KiB output
cases. `test/unit/pid_file_test.rb` separately pins strict-vs-legacy identity
