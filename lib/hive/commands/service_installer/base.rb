  ...
  module Commands
    module ServiceInstaller
      ...
      class Base
        ...
        def service_name
          raise NotImplementedError, "#{self.class} must define #service_name"
        end

        def cli_label
          raise NotImplementedError, "#{self.class} must define #cli_label"
        end

        def service_noun
          raise NotImplementedError, "#{self.class} must define #service_noun"
        end
        ...
        def render_systemd
          raise NotImplementedError, "#{self.class} must define #render_systemd"
        end

        def render_launchd
          raise NotImplementedError, "#{self.class} must define #render_launchd"
        end

        # Optional message appended to @messages on the Linux force-upgrade
        # restart path. Return nil to skip (the bot has no long stop drain
        # to warn about).
