...
require Git 2.45+ and use `--no-lazy-fetch`; safe creation races on the skip log are revalidated
once, while replacement races are rejected and warned.
