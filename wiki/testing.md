...
| `hv_test.rb` | `bin/hv` — refuses unsafe Apache Hive fallback paths, verifies `HIVE_BIN_OVERRIDE`, bounds probes with timeout kill-after or the process-group watchdog, and cleans up TERM-ignoring helpers. |
