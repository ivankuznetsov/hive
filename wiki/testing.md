...
| `unit/attempts/detached_launcher_test.rb` | Durable-attempt handoff — POSIX session detachment, capability/ready descriptor transfer, launch timeout and preflight failures, and Linux systemd-user sibling-scope placement that keeps accepted wrappers outside the daemon service's OOM cgroup. |
