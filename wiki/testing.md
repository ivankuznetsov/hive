...
| File | Covers |
|------|--------|
| `config_test.rb` | `Hive::Config` — defaults, deep-merge, register/find, malformed YAML rejection, normal and patrol reviewer validation, Screenote base URL validation, and the migration error for obsolete `screenote.api_token`. |
