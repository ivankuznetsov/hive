...
**TLDR**: Six pipeline stages, two of which are inert (1-inbox, 7-done) and four of which spawn `claude -p` agents. Each has exactly one state file and one runner module.
