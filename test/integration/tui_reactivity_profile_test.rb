...
class TuiReactivityProfileTest < Minitest::Test
  ...
  def test_scale_fixture_is_parseable_and_profiled
    ...
    with_tmp_global_config do |home|
      ...
      assert_equal ACTIVE_TOTAL, source.current.rows.size
      ...
      active_parse_seconds = median_seconds { Hive::Commands::Status.new.active_payload(projects) }
      ...
      puts format(
        ...
        active_ms: format("%.2f", active_parse_seconds * 1000)
      )
    end
  end
