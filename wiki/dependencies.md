...
| `npm` | any recent npm with Node.js | bounded downloader/installer for the integrity-checked QMD tarball and its native better-sqlite3 rebuild; Hive reports missing npm but does not install Node.js/npm itself |
