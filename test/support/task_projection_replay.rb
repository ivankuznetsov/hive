  ...
  class TaskProjectionReplay
    ...
    def replay(shuffle: false)
      Dir.mktmpdir("task-projection-replay") do |dir|
        ...
        projection = history_reader(task_folder).read(marker: marker)
    ...
    def history_reader(task_folder)
      Hive::TaskProjection::Reader.new(task_folder: task_folder)
    end
