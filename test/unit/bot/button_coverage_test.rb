...
class HiveBotButtonCoverageTest < Minitest::Test
  ...
  INERT_KINDS = %w[admission_error agent_running archived manual_steering review_parked watching].freeze
  ...
  def test_new_task_action_kind_requires_row_action_decision
    expected = %w[
      ...
      ready_to_run admission_error agent_running archived manual_steering review_parked watching
    ]
