...
module Hive
  module Stages
    module Review
      ...
      # `REVIEW_COMPLETE browser=warned` lands; the finalize stage surfaces the
      ...
      module BrowserTest
        ...
        # details so the user (or the finalize stage's PR body) sees the full
