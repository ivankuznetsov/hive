...
per-entry path rewrites, one complete gzip member, canonical zero tar padding,
and bounded archive scanning are now deterministic U1a admission rules. Only
downstream production and live composition remain.
