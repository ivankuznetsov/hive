...
| `workflow_package/*_test.rb`, `commands/workflow_{install,list,remove,update,publish}_test.rb` | Honeycomb package canonicalization/security, registry ancestry/ref resolution, immutable store transactions/task pins, runner policy compilation, semantic escalation, lifecycle consent/ownership, deterministic packaging, and injected fork/PR seams. |
