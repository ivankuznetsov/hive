...
Skillpack, Safe Agent Git Gate, WorkLedger, and Workflow Creator Proof—and two
guarded candidates: Attempts admission and Patrol Effect Evidence.
Skillpack's downward dependency on the Agent ABI is the only
component-to-component edge; Patrol retains its bounded U3 migration
exception. Workflow Creator Proof is a non-claiming U1 contract; U14 and U15
still own execution custody and live orchestration. Hive is the first and
