...
| `markers_test.rb` | `Hive::Markers` — set/get round-trip, attribute quoting, last-marker semantics, and the shared `input_marker?` allowlist for real operator-input states. |
