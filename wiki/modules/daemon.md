...
only on exit 0. Completion also receives the child's structured JSON envelope:
a typed permanent delivery/checkpoint error persists `blocked_date` and
