...
class TuiHelpTest < Minitest::Test
  ...
  def test_modes_are_drawn_from_a_known_set
    expected_modes = %i[grid triage log_tail red_status_detail implementation_identity_detail
                        token_stats archive filter idea_preview new_idea_project new_idea].to_set
