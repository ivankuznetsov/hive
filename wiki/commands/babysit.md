...
- `test/unit/babysitter/dry_run_env_test.rb` includes PTY-backed regressions for forced `git --no-pager` passthrough and prompt-disabled identifier-less `gh workflow view` / `gh run view` reads.
