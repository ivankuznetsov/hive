...
interpolates the externally supplied PR `headRefName` as
`Shellwords.escape("refs/heads/<ref>")` (fetch/push) and
...
push lands on the fully qualified remote ref. See [[modules/babysitter]].