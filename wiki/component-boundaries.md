...
The catalog retains fourteen components: ten are `boundary-ready`; Provider
Health, Provider Routing Policy, Attempts, and Patrol Effect Evidence remain
`candidate`.
...
while Provider Health, Provider Routing Policy, Attempts, and Patrol Effect
Evidence are deliberately retained as guarded candidates rather than being
promoted ahead of their remaining lifecycle or qualification proof.
