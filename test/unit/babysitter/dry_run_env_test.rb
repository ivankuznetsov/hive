...
class BabysitterDryRunEnvTest < Minitest::Test
  ...
  def test_stubs_skip_unknown_and_mutating_commands_but_allow_read_only_commands
    with_tmp_dir do |dir|
      ...
      assert_stubbed env, "gh", "api", "graphql", "--method", "GET", "-f", "query=mutation { closePullRequest(input: {}) { clientMutationId } }"
      assert_stubbed env, "gh", "api", "graphql", "--method=GET", "--raw-field=query= mutation { closePullRequest(input: {}) { clientMutationId } }"
      ...
      assert_passes env, "gh", "api", "graphql", "--method", "GET", "-f", "query={ viewer { login } }"
      ...
      assert_includes skipped, "gh api graphql --method GET -f query=mutation { closePullRequest(input: {}) { clientMutationId } } skipped"
      assert_includes skipped, "gh api graphql --method=GET --raw-field=query= mutation { closePullRequest(input: {}) { clientMutationId } } skipped"
      ...
      assert_includes real_invocations, "real-gh api graphql --method GET -f query={ viewer { login } }"
