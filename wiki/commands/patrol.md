...
1. Reconcile every durable finding with merged/open fingerprint state and closed-unmerged dismissals. Legacy records load as active; resolved and rejected semantic roots remain terminal.
