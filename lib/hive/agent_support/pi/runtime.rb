...
module Hive::AgentSupport::Pi::Runtime
  ...
  def self.compile_evidence_actor(host:, task_folder:, package_root:, profile:, environment:,
                                     ...
                                     browser: false, project_server: browser)
    ...
    Hive::AtomicFile.write(
      ...
      evidence_extension(
        ...
        browser: browser, project_server: project_server
      ),
      mode: 0o600
    )
    ...
    tool_names << "evidence_server" if project_server
    flags = [
