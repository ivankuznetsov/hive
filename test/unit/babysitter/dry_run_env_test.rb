...
class BabysitterDryRunEnvTest < Minitest::Test
  ...
  def test_stubs_skip_unknown_and_mutating_commands_but_allow_read_only_commands
    with_tmp_dir do |dir|
      ...
      assert_stubbed env, "gh", "api", "--method", "GET", "repos/owner/repo/issues", "-iF", "q=@secret"
      ...
      assert_passes env, "gh", "api", "-i", "repos/owner/repo"
      assert_passes env, "gh", "api", "--method", "GET", "repos/owner/repo/issues", "-f", "state=open"
      assert_passes env, "gh", "api", "--method", "GET", "repos/owner/repo/issues", "-F", "state=open"
      assert_passes env, "gh", "api", "-iX", "GET", "repos/owner/repo/issues", "-if", "state=open"
      ...
      assert_includes skipped, "gh api --method GET repos/owner/repo/issues -iF q=@secret skipped"
