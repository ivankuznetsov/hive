...
# Release maintainers: bump v0.3.5 in both installer URLs when cutting a new stable release.
curl -fsSL https://raw.githubusercontent.com/ivankuznetsov/hive/v0.3.5/install.sh -o "$tmpdir/hive-install.sh"
