...
The same predicate crosses package-admission and hook locks and is rechecked
immediately before new-hook and retry provider dispatch. Closing admission
while one of those locks is held cannot launch work after shutdown.
